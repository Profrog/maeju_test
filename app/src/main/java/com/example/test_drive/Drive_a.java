...
public abstract class Drive_a extends Activity{
    public static final String TAG = "drive-a";
    ...
    protected Task<DriveId> pickTextFile() {
        OpenFileActivityOptions openOptions =
                new OpenFileActivityOptions.Builder()
                        ...
                        .setActivityTitle(getString(R.string.file_name))
                        .build();
    ...
    protected Task<DriveId> pickFolder() {
        OpenFileActivityOptions openOptions =
                new OpenFileActivityOptions.Builder()
                        ...
                        .setActivityTitle(getString(R.string.folder_name))
                        .build();
        return pickItem(openOptions);
    }
