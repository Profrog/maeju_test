...
import static com.example.logintest.Configuration.KEY_DATE;
...
public class SubmitActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if(v == buttonSubmit){
            if (editTextUserId.getText().toString().replace(" ", "").equals("")) {
                AlertDialog.Builder builder = new AlertDialog.Builder(this);
                builder.setTitle("warning").setMessage("학번이 없습니다. 확인해주십시오.");
            ...
            else if (editTextUserName.getText().toString().replace(" ", "").equals("")) {
                AlertDialog.Builder builder = new AlertDialog.Builder(this);
                builder.setTitle("warning").setMessage("이름이 없습니다. 확인해주십시오.");
                builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
